...
bundles.locomotives = {
    ...
    */
    "CBQ2" : {
        ...
        model:{
            speed:function(mph) {
                return mph/128; //totally not correct but it is a functional example
                ...
                */
                "te" : function(speed, trainPosition) {
                    ...
                    */
                    ...
                    return teLbs; //the abs is to protect against returning -0
                },
                /*
        ...
        prototype : {
            ...
            brake : {
                ...
                reduction: function(trainPosition, psi) {
                    ...
                    $({ n: train.all[trainPosition].prototype.brake.cylinderPSI }).animate({ n: resultingCylinderPSI}, {
                        duration: timeToWait,
