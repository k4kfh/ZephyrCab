...
function protoEngine_accel(ARGnotch, ARGreverser) {
 if (locoAddress != undefined) {
     ...
     //find wind resistance, which is actually a motive force trying to move the loco in the direction of the wind
     //it is assumed (in this version) that the wind is coming directly at the front of the locomotive...might allow more in the future but this is simpler
     ...
     if (ARGreverser == "forward") {
         motiveForce = (outputHP * 550) - windResistance
         console.log("Total motive force: " + motiveForce)
     }
     else if (ARGreverser == "neutral") {
         motiveForce = 0 - windResistance
         console.log("Total motive force: " + motiveForce)
     }
     else if (ARGreverser == "reverse") {
