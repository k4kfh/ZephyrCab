...
//this is where you set (in milliseconds) how long is required to wait between changing the notch. This is for prototypical accuracy, not the minimum required wait time for the decoder to function correctly. If your prototype locomotive does not have a "ratcheting" notched throttle, set this to 0.
